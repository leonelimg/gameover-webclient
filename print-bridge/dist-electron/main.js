...
let bridgeInitialStartTimer = null;
...
const sanitizeSettings = (raw) => {
    ...
    const transport = rawTransport === "rawfile" || rawTransport === "winspooler" ? rawTransport : "serial";
    return {
...
const buildMainHtml = (settings) => `<!doctype html>
<html lang="es">
<head>
  <meta charset="utf-8" />
...
const buildHealthHtml = (port) => `<!doctype html>
<html lang="es">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
...
const buildSettingsHtml = (settings) => `<!doctype html>
<html lang="es">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
    ...
    settingsWindow.webContents.on("will-navigate", (event, url) => {
        ...
        try {
            ...
            const updated = sanitizeSettings({
                ...
                transport: parsedUrl.searchParams.get("transport") ?? currentSettings.transport,
