...
export const APP_RESOURCES: AppResource[] = [
  ...
  { key: '/restrictions/global-numbers', label: 'Restricciones: globales por numero' },
  ...
  { key: '/restrictions:update-global-numbers', label: 'Restricciones: actualizar globales por numero' },
...
const DEFAULT_RESOURCE_ACCESS: Record<string, AppRole[]> = {
  ...
  '/restrictions/global-numbers': ['admin', 'asociado'],
  ...
  '/restrictions:update-global-numbers': ['admin', 'asociado'],
